...
class TestCLICommandFunctions:
    ...
    def test_list_profiles_command(self, capsys):
        ...
        with patch('nanopore_simulator.cli.main.get_available_profiles') as mock_profiles:
    ...
    def test_list_adapters_command(self, capsys):
        ...
        with patch('nanopore_simulator.cli.main.get_available_adapters') as mock_adapters:
    ...
    def test_recommend_profiles_command_success(self, capsys):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('nanopore_simulator.cli.main.get_profile_recommendations') as mock_rec:
                with patch('nanopore_simulator.cli.main.get_available_profiles') as mock_profiles:
...
class TestCLISpecialOptions:
    ...
    def test_cli_list_profiles_option(self):
        ...
        with patch.object(sys, 'argv', ['nanorunner', '--list-profiles']):
            with patch('nanopore_simulator.cli.main.list_profiles_command', return_value=0) as mock_cmd:
                result = main()
                assert result == 0
    ...
    def test_cli_list_adapters_option(self):
        ...
        with patch.object(sys, 'argv', ['nanorunner', '--list-adapters']):
            with patch('nanopore_simulator.cli.main.list_adapters_command', return_value=0) as mock_cmd:
                result = main()
                assert result == 0
                mock_cmd.assert_called_once()
    ...
    def test_cli_recommend_profiles_option(self):
        ...
        with patch.object(sys, 'argv', ['nanorunner', '--recommend', '/test/path']):
            with patch('nanopore_simulator.cli.main.recommend_profiles_command', return_value=0) as mock_cmd:
                result = main()
                assert result == 0
    ...
    def test_cli_validate_pipeline_option(self):
        ...
        with patch.object(sys, 'argv', ['nanorunner', '--validate-pipeline', 'nanometanf', '/test/path']):
            with patch('nanopore_simulator.cli.main.validate_pipeline_command', return_value=0) as mock_cmd:
                result = main()
                assert result == 0
    ...
    def test_cli_invalid_profile_name(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(sys, 'argv', [
                ...
                with patch('nanopore_simulator.cli.main.validate_profile_name', return_value=False):
    ...
    def test_cli_permission_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(sys, 'argv', [
                ...
                with patch('nanopore_simulator.cli.main.NanoporeSimulator') as mock_sim_class:
                    mock_sim = MagicMock()
                    mock_sim.run_simulation.side_effect = PermissionError("Permission denied")
                    mock_sim_class.return_value = mock_sim
