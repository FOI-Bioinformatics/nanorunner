...
from nanopore_simulator.core.timing import (
    TimingModel, UniformTimingModel, RandomTimingModel, 
    PoissonTimingModel, AdaptiveTimingModel, create_timing_model
)
...
class TestPoissonTimingModel:
    ...
    def test_burst_mode_creates_shorter_intervals(self):
        ...
        burst_model = PoissonTimingModel(base_interval, burst_probability=0.5, burst_rate_multiplier=5.0)
    ...
    def test_exponential_distribution_properties(self):
        ...
        assert 0.30 < proportion < 0.44  # Allow some statistical variance around 1/e ≈ 0.368
...
class TestAdaptiveTimingModel:
    ...
    def test_reset_functionality(self):
        ...
        assert model.current_mean != adapted_mean  # Should be different from adapted state
...
class TestTimingModelFactory:
    ...
    def test_create_poisson_model(self):
        ...
        model = create_timing_model("poisson", 5.0, burst_probability=0.2, burst_rate_multiplier=3.0)
    ...
    def test_create_adaptive_model(self):
        ...
        model = create_timing_model("adaptive", 5.0, adaptation_rate=0.2, history_size=8)
