...
from tests.fixtures.realistic_data_fixtures import (
    realistic_sequencing_data, minion_run_fixture, 
    promethion_run_fixture, multiplex_run_fixture
)
...
class TestRealisticTimingBehavior:
    ...
    def test_poisson_timing_with_realistic_bursts(self, minion_run_fixture):
        ...
        normal_intervals = [i for i in intervals if i >= base_interval * 0.8]  # Close to base interval
        burst_intervals = [i for i in intervals if i <= base_interval * 0.5]   # Burst intervals
