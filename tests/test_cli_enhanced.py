...
class TestCLIEnhancedMonitoring:
    ...
    def test_cli_enhanced_monitoring_option(self):
        ...
        with patch.object(sys, 'argv', [
            ...
            with patch('nanopore_simulator.cli.main.NanoporeSimulator') as mock_simulator:
                main()
        ...
        with patch.object(sys, 'argv', [
            ...
            with patch('builtins.print') as mock_print:
                with patch('nanopore_simulator.cli.main.NanoporeSimulator'):
                    ...
                    instruction_calls = [call for call in print_calls 
                                       if 'Enhanced monitoring active' in call or 
                                          'Ctrl+C' in call or 
                                          'checkpointed' in call]
    ...
    def test_cli_no_monitoring(self):
        ...
        with patch.object(sys, 'argv', [
            ...
            with patch('nanopore_simulator.cli.main.NanoporeSimulator') as mock_simulator:
                ...
                assert monitor_type == "default"  # Default used when monitoring disabled
