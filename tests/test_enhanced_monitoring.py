...
class TestResourceMetrics:
    ...
    def test_resource_metrics_creation(self):
        ...
        metrics = ResourceMetrics(
            cpu_percent=50.0, memory_percent=75.0, memory_used_mb=1024.0
        )
    ...
    def test_resource_history_tracking(self):
        ...
        for i in range(65):
            resource = ResourceMetrics(
                cpu_percent=float(i), memory_used_mb=float(i * 10)
            )
...
class TestEnhancedProgressMonitor:
    ...
    def test_enhanced_monitor_creation(self):
        ...
        monitor = ProgressMonitor(
            total_files=100, enable_resources=True, enable_checkpoint=True
        )
    ...
    def test_enhanced_monitor_without_features(self):
        ...
        monitor = ProgressMonitor(
            total_files=50, enable_resources=False, enable_checkpoint=False
        )
    ...
    def test_performance_warnings(self):
        ...
        if monitor.resource_monitor:
            high_usage_metrics = ResourceMetrics(
                cpu_percent=95.0, memory_percent=90.0, disk_usage_percent=95.0
            )
...
class TestProgressDisplay:
    ...
    def test_enhanced_progress_line_with_resources(self):
        ...
        progress_line = ProgressDisplay.format_progress_line(
            metrics, show_resources=HAS_PSUTIL and metrics.resource_metrics is not None
        )
...
class TestMonitorFactory:
    ...
    def test_create_enhanced_monitor(self):
        ...
        monitor = create_progress_monitor(total_files=100, monitor_type="enhanced")
...
class TestIntegration:
    ...
    def test_enhanced_monitoring_with_psutil_mock(self):
        ...
        with patch(
            ...
            monitor = ProgressMonitor(
                total_files=10, enable_resources=True, update_interval=0.1
            )
